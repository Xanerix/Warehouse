...
public class local {
    ...
    // 修复后的方法 - 将Object参数改为int类型
    public static ValueAnimator ValueAnimatorAGB(final View view, int value1, int value2, int time, int frequency, final int fillet, final String f) {
    ...
    // 修复后的方法 - 将Object参数改为int类型
    public static ValueAnimator ValueAnimator(final View view, int value1, int value2, int time, int frequency, ValueAnimator.AnimatorUpdateListener set) {
        ValueAnimator valueAnimator = ValueAnimator.ofInt(value1, value2);
